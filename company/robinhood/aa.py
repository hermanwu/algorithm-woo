'''
Our goal is to build a simplified version of a real Robinhood system that reads a customer's trades from a stream, maintains what they own, and rectifies running out of cash (through a process called a "margin call", which we'll define later). 
...
["3", "GOOG", "B", "20", "5"],
["10", "AAPL", "S", "5", "15"]]
is equivalent to buying 10 shares (i.e. units) of AAPL for $10 each at timestamp 1, buying 20 shares of GOOG for $5 each at timestamp 3, and selling 5 shares of AAPL for $15 at timestamp 10.
...
["2", "AAPL", "S", "2", "80"],
["3", "GOOG", "B", "15", "20"]]
The customer would be left with 8 AAPL shares, 15 GOOG shares, and $-140 in cash. They would need to sell 2 shares of AAPL (at $80 a share) to cover the deficit. Afterwards, they would have 6 shares of AAPL, 15 shares of GOOG, and a cash balance of $20.
...
As a result, the margin call process will now sell the most valuable non-collateral share until the balance is positive again. Note that if this sells a special stock, some of the c‍‌‌‍‌‍‍‌‍‌‌‍‍‌‍‍‍‌ollateral stock may be freed up to be sold.

For example, if the customer purchases 5 shares of AAPL for $100 each, then 5 shares of GOOG for $75 each, then finally 5 shares of AAPLO for $50 each, they would have a cash balance of -$125, but their shares of AAPL can no longer be used to cover the deficit (since they've become collateral for AAPLO). As a result, 2 shares of GOOG would be sold back (again at $75 each), leaving the customer with $25, 5 AAPL, 5 AAPLO, and 3 GOOG. Thus, with an input of
...
[input] array.array.string trades_to_parse
