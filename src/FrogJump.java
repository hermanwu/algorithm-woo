...
/**
 ...
 the gap between the 5th and 6th stone is too large.e set [2, 3, 6, 7] and target 7,
 A solution set is:
...
public class FrogJump {
    public static void main(String[] args) {
        ...
        FrogJump c = new FrogJump();

        boolean result  = c.canCross(stones);

        Printer.printResultComparsion(result, false);
    }
    ...
    public boolean canCross(int[] stones) {
        ...
        // set includes the last steps it took to move to the current stone.
